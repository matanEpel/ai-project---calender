...
def main_amit():
    ...
    """
    c = Constraints()
    c.set_soft_constraint("finish the day early", 100)
    ofir = User("Ofir", c)
    matan = User("matan", c)
    amit = User("amit", c)
    ...
    # b3 = Assignment(week=1, name="m3", duration=Time(h=4), kind=kinds["MEETING"], participants=[ofir, amit, matan])
    ...
    amit.add_assignment(deepcopy(a1))
